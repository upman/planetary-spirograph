...
Tangle.classes.TKAdjustableNumber = {
    ...
    touchDidMove: function (touches) {
        ...
        this.updateHelp();
								...
								// Create the event
								var event = new CustomEvent("reset-spirograph", { "detail": "TKAdjustableNumber Dragging" });
					console.log(this.element['data-reset-spirograph']);
								if(this.element.getAttribute('data-reset-spirograph') !== "false") {
